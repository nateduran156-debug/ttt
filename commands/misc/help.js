...
const CATS = {
  ...
  roblox: {
    ...
    cmds: [
      ...
      { name: 'tag',        desc: 'Apply a Roblox group tag to a user.',                    aliases: ['t'],                        parameters: 'username tag',        info: 'Tags: rockstar, Fraid, FaZe, dark, sharingan tag', usage: '.tag <username> <tag>', example: '.tag builderman rockstar' },
